...
const inputClass =
  "w-full rounded-lg border border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-900 px-3 py-2.5 text-base outline-none focus:border-slate-900 focus:ring-1 focus:ring-slate-900";
  ...
  if (needsConfirmation) {
    return (
      <div className="mt-8 rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 p-5">
        ...
        <Link
          href="/login"
          className="mt-5 block rounded-lg bg-slate-900 dark:bg-slate-100 py-2.5 text-center text-base font-medium text-white dark:text-slate-900"
        >
          回到登入
        </Link>
      </div>
    ...
    <form onSubmit={onSubmit} className="mt-8 space-y-4">
      ...
      <div className="space-y-1.5">
        ...
        <input
          ...
          className={inputClass}
        />
        <p className="text-xs text-slate-400 dark:text-slate-500">至少 8 個字元</p>
      </div>
      ...
      <p className="text-center text-sm text-slate-500 dark:text-slate-400">
        已經有帳號了？
        <Link href="/login" className="ml-1 font-medium text-slate-900 dark:text-slate-100 hover:underline">
          登入
        </Link>
      </p>
    </form>
