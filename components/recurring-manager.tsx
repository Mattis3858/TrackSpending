    ...
    <div className="space-y-6">
      {templates.length > 0 && (
        <section className="rounded-2xl bg-slate-900 dark:bg-slate-800 px-5 py-5 text-white dark:text-slate-100">
          <p className="text-sm text-slate-400 dark:text-slate-500">每月固定支出合計</p>
      ...
      >
        <div>
          <p className="text-sm font-medium text-slate-600 dark:text-slate-300">新增固定支出</p>
        ...
        <select
          ...
          className="w-full rounded-lg border border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-900 px-3 py-2.5 text-base outline-none focus:border-slate-900"
        >
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          <div className="flex items-center gap-2">
            <span className="shrink-0 text-sm text-slate-500 dark:text-slate-400">每月</span>
            <input
              value={day}
              ...
              className={inputClass}
            />
            <span className="shrink-0 text-sm text-slate-500 dark:text-slate-400">號</span>
          </div>
        </div>
              ...
              <li key={t.id} className="px-4 py-3">
                <div className="flex items-center gap-3">
                  ...
                  <span className="min-w-0 flex-1">
                    ...
                    <span className="tabular block text-xs text-slate-400 dark:text-slate-500">
                      每月 {t.dayOfMonth} 號
                    </span>
                  </span>
